    ...
    (header-panel :mode "seamed"
                  ...
                  (:div :style "padding:20px;" :class "schedule layout vertical center"
                        (:div :style "max-width:700px;"
                              ...
                              (:h3 "<span class='schedule'>2:00PM</span>The 24 hour clock starts")
                              ...
                              (:h3 "<span class='schedule'>2:30 PM - 5:30 PM</span>Team Presentations")
                              (:h3 "<span class='schedule'>5:30 PM</span>Award Presentation"))))))
